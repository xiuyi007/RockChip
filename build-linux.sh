#!/bin/bash
GCC_COMPILER=/home/insslab/Desktop/RockChip/arm-rockchip830-linux-uclibcgnueabihf/bin/arm-rockchip830-linux-uclibcgnueabihf
set -e
...
for demo_path in `find CProgram -name ${BUILD_DEMO_NAME}`
do
    if [ -d "$demo_path/cpp" ]
    then
